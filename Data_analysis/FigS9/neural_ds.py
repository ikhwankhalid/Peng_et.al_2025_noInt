...
class NeuralDatasetSimple(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.original_position_cartesian = original_position_cartesian
    ...
    def __getitem__(self, index):
        ...
        cartesian_pose = self.original_position_cartesian[
            self.validIndices[index] : self.validIndices[index] + 1, :
        ]
        originalIfrData = self.oriIfr[
            self.validIndices[index] : self.validIndices[index] + 1, :
        ]

        original_index = int(self.validIndices[index])
        ...
        return (
            ...
            original_index,
            cartesian_pose,
            # originalIfrData, NOTE modified 15.10.2024 here
        )  # we only need one channel for the mask